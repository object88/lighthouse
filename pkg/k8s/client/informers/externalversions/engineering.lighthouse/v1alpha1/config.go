...
import (
	...
	engineeringlighthousev1alpha1 "github.com/object88/lighthouse/pkg/k8s/apis/engineering.lighthouse/v1alpha1"
	versioned "github.com/object88/lighthouse/pkg/k8s/client/clientset/versioned"
	internalinterfaces "github.com/object88/lighthouse/pkg/k8s/client/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/object88/lighthouse/pkg/k8s/client/listers/engineering.lighthouse/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.EngineeringV1alpha1().Configs(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.EngineeringV1alpha1().Configs(namespace).Watch(context.TODO(), options)
			},
		},
		&engineeringlighthousev1alpha1.Config{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *configInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&engineeringlighthousev1alpha1.Config{}, f.defaultInformer)
}
