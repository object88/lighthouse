...
type FakeConfigs struct {
	Fake *FakeEngineeringV1alpha1
	ns   string
}

var configsResource = schema.GroupVersionResource{Group: "engineering.lighthouse", Version: "v1alpha1", Resource: "configs"}

var configsKind = schema.GroupVersionKind{Group: "engineering.lighthouse", Version: "v1alpha1", Kind: "Config"}
